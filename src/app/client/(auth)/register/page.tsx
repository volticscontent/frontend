...
const formSchema = z.object({
  ...
  plan: z.enum(["TRIAL", "AGENCY", "BUSINESS"] as const),
})
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Minha Agência" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Slug (URL do painel)</FormLabel>
                    <FormControl>
                  ...
                  <FormItem>
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="AGENCY">Agency (Serviços + Sistema)</SelectItem>
                        <SelectItem value="BUSINESS">Business (Apenas Sistema)</SelectItem>
                      </SelectContent>
                    </Select>
                    <FormMessage />
                  </FormItem>
